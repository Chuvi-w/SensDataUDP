...
class Vector2D
{
 public:
    ...
    */
   Vector2D(const Vector2D* pVector) : x(pVector->x), y(pVector->y) {}
   ...
   inline const double GetDot(const Vector2D& vector) const;
   inline const double GetAngle(const Vector2D& vector) const;
   inline const double GetPolarAngle() const;
   inline const double GetDistance(Vector2D& vector) const;
   ...
   inline Vector2D& SetMagnitude(const double& magnitude);
   ...
   inline Vector2D  GetMul(const double& scalar) const;
   inline Vector2D& SetMul(const double& scalar);
   inline Vector2D& SetMul(const Vector2D& vector, const double& scalar);

   inline Vector2D  GetDiv(const double& scalar) const;
   inline Vector2D& SetDiv(const double& scalar);
   inline Vector2D& SetDiv(const Vector2D& vector, const double& scalar);
 ...
 */
inline const double Vector2D::GetMagnitude() const { return static_cast<double>(sqrt(x * x + y * y)); }
 ...
 */
inline const double Vector2D::GetDot(const Vector2D& vector) const { return (x * vector.x + y * vector.y); }
 ...
 */
inline const double Vector2D::GetAngle(const Vector2D& vector) const
{
   const double magnitudesProduct = GetMagnitude() * vector.GetMagnitude();

   if(magnitudesProduct != 0.0f)
      return static_cast<double>(MathUtils::ArcCos(GetDot(vector) / magnitudesProduct));
   else
      return 0.0f;
}
 ...
 * @return angle value
 */
inline const double Vector2D::GetPolarAngle() const
{
   const Vector2D reference(1, 0);

   return static_cast<double>(GetAngle(reference));
}
 ...
 */
inline const double Vector2D::GetDistance(Vector2D& vector) const
{
   Vector2D tmp = *this;
   tmp -= vector;
 ...
 */
inline Vector2D Vector2D::GetInverted() const { return Vector2D(-x, -y); }
 ...
 */
inline Vector3D Vector2D::GetCross(const Vector2D& vector) const { return Vector3D(0, 0, x * vector.y - y * vector.x); }
 ...
 * @return new vector
 */
inline Vector2D& Vector2D::SetMagnitude(const double& magnitude)
{
 ...
 */
inline Vector2D& Vector2D::SetProjected(const Vector2D& vector) { return SetProjected(*this, vector); }
...
{
   const double selfDot = vector2.GetDot(vector2);

   if(selfDot != 0.0f) *this = (((vector1.GetDot(vector2)) / (selfDot)) * vector2);
 ...
 */
inline Vector2D Vector2D::GetAdd(const Vector2D& vector) const { return Vector2D(this->x + vector.x, this->y + vector.y); }
 ...
 */
inline Vector2D Vector2D::GetSub(const Vector2D& vector) const { return Vector2D(this->x - vector.x, this->y - vector.y); }
 ...
 */
inline Vector2D Vector2D::GetMul(const double& scalar) const { return Vector2D(this->x * scalar, this->y * scalar); }
 ...
 * @return scaled vector
 */
inline Vector2D& Vector2D::SetMul(const double& scalar)
{
   this->x *= scalar;
   this->y *= scalar;
 ...
 * @return scaled vector
 */
inline Vector2D& Vector2D::SetMul(const Vector2D& vector, const double& scalar)
{
 ...
 * @return scaled vector
 */
inline Vector2D Vector2D::GetDiv(const double& scalar) const { return Vector2D(this->x / scalar, this->y / scalar); }
 ...
 * @return scaled vector
 */
inline Vector2D& Vector2D::SetDiv(const double& scalar)
{
   this->x /= scalar;
   this->y /= scalar;
 ...
 * @return scaled vector
 */
inline Vector2D& Vector2D::SetDiv(const Vector2D& vector, const double& scalar)
{
   this->x = vector.x / scalar;
   this->y = vector.y / scalar;
 ...
 * @return equal value
 */
inline const bool Vector2D::equals(const Vector2D& vector) const { return ((this->x == vector.x) && (this->y == vector.y)); }
 ...
 */
inline const bool Vector2D::notEquals(const Vector2D& vector) const { return ((this->x != vector.x) && (this->y != vector.y)); }
 ...
 * @return summation result
 */
inline Vector2D Vector2D::operator+(const Vector2D& vector) const { return Vector2D(x + vector.x, y + vector.y); }
 ...
 * @return scaled vector
 */
inline Vector2D Vector2D::operator*(const double& scalar) const { return Vector2D(x * scalar, y * scalar); }
 ...
 * @return scaled vector
 */
inline Vector2D Vector2D::operator/(const double& scalar) const
{
   if(scalar != 0.0f)
 ...
 */
inline Vector2D& Vector2D::operator*=(const double& scalar)
{
   x *= scalar;
   y *= scalar;
   return *this;
 ...
 * @return equal value
 */
inline const bool Vector2D::operator==(Vector2D& vector) const { return ((x == vector.x) && (y == vector.y)) ? true : false; }
 ...
 */
inline Vector2D operator*(double scalar, Vector2D& vector) { return Vector2D(vector.x * scalar, vector.y * scalar); }
 ...
 * @return scaled vector instance
 */
inline Vector2D operator*(double scalar, const MATHLIB3D::Vector2D& vector) { return Vector2D(vector.x * scalar, vector.y * scalar); }
