...
RecvSourceType_e CRecvSrcUDP::GetSourceType() const
{
   return RecvSrcUDP;
}

sf::IpAddress CRecvSrcUDP::GetIP() const
{
   return m_IP;
}

uint16_t CRecvSrcUDP::GetPort() const
{
   return m_Port;
}
...
RecvSourceType_e CRecvSrcFile::GetSourceType() const
{
   return RecvSrcFile;
}
