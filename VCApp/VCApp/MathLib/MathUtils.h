...
namespace MATHLIB3D {
   ...
   template<typename ML_VECTOR_T>  ML_VECTOR_T GetVAvg(const std::vector<ML_VECTOR_T> &vData)
   {
      ...
      if(!vData.empty())
      {
         for(const auto &v : vData){VecAvg += v;}
 ...
 */
inline double MathUtils::Cos(const double& value) {
	return static_cast<double>(cos(value));
}
 ...
 * @todo numerical approximation
 */
inline double MathUtils::Sin(const double& value) {
	return static_cast<double>(sin(value));
}
 ...
 * @todo numerical approximation
 */	
inline double MathUtils::Tan(const double& value) {
	return static_cast<double>(tan(value));
}
 ...
 * @todo numerical approximation
 */
inline double MathUtils::ArcCos(const double& value) {
	return static_cast<double>(acos(value));	
}
 ...
 * @todo numerical approximation
 */
inline double MathUtils::ArcSin(const double& value) {
	return static_cast<double>(asin(value));
}
 ...
 * @todo numerical approximation
 */
inline double MathUtils::ArcTan(const double& value) {
	return static_cast<double>(atan(value));
}
 ...
 */
inline double MathUtils::DegToRad(const double& value) {
 ...
 */
inline double MathUtils::RadToDeg(const double& value) {
 ...
 */
inline double MathUtils::Abs(const double& value) {
 ...
 * @return floor value
 */
inline int MathUtils::Floor(const double& value) {
 ...
 */	
inline int MathUtils::Ceiling(const double& value) {
 ...
 * @return round value
 */
inline int MathUtils::Round(const double& value) {
	return ((value) > 0 ? static_cast<int>(value + 0.5f) : -static_cast<int>(0.5f - value));
}

inline double MathUtils::FloatRound1000(const double& value) {
	return static_cast<double>(Round(value*10000)/10000.0);
}
 ...
 */
inline int MathUtils::Sign(const double& value) {
	return (((value) < 0) ? -1 : 1);
}
 ...
 */
inline double MathUtils::Min(const double& value1, const double& value2) {
 ...
 */
inline double MathUtils::Max(const double& value1, const double& value2) {
	return (((value1) > (value2)) ? (value1) : (value2));
}
