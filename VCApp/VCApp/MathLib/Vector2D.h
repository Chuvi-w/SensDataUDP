 ...
 */
inline const double Vector2D::GetMagnitude() const {
 ...
 */
inline const double Vector2D::GetDot(const Vector2D& vector) const {
 ...
 */
inline Vector2D Vector2D::GetMul(const double& scalar) const {
 ...
 * @return scaled vector
 */
inline Vector2D Vector2D::GetDiv(const double& scalar) const {
	return Vector2D(this->x / scalar, this->y / scalar);
}
 ...
 */
inline Vector2D operator * (double scalar, Vector2D& vector) {
 ...
 * @return scaled vector instance
 */
inline Vector2D operator * (double scalar, const MATHLIB3D::Vector2D& vector) {
	return Vector2D(vector.x * scalar, vector.y * scalar);
}
