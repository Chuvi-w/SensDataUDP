...
NMEAParser::NMEAParser() : log(false), maxbuffersize(NMEA_PARSER_MAX_BUFFER_SIZE), fillingbuffer(false) {}
...
void NMEAParser::onError(NMEASentence& nmea, string txt) { throw NMEAParseError("[ERROR] " + txt); }
