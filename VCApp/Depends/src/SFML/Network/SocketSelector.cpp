...
////////////////////////////////////////////////////////////
SocketSelector::SocketSelector(const SocketSelector& copy) : m_impl(new SocketSelectorImpl(*copy.m_impl)) {}

////////////////////////////////////////////////////////////
SocketSelector::~SocketSelector() { delete m_impl; }
...
void SocketSelector::add(Socket& socket)
{
   ...
   if(handle != priv::SocketImpl::invalidSocket())
   {
      ...
      if(FD_ISSET(handle, &m_impl->allSockets)) return;
