...
volatile double Madg_Fix_beta = betaDef;								// 2 * proportional gain (Kp)
volatile double Madg_Fix_q0 = 1.0f, Madg_Fix_q1 = 0.0f, Madg_Fix_q2 = 0.0f, Madg_Fix_q3 = 0.0f;	// quaternion of sensor frame relative to auxiliary frame
...
void MadgwickAHRSupdate_Fixed(double gx, double gy, double gz, double ax, double ay, double az, double mx, double my, double mz)
{
   ...
   double _2q0mx, _2q0my, _2q0mz, _2q1mx, _2bx, _2bz, _4bx, _4bz, _8bx, _8bz, _2q0, _2q1, _2q2, _2q3, _2q0q2, _2q2q3, q0q0, q0q1, q0q2, q0q3, q1q1, q1q2, q1q3, q2q2, q2q3, q3q3;
	...
	if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
      ...
      s3 = _2q1*(2.0f*(q1q3 - q0q2) - ax) + _2q2*(2.0f*(q0q1 + q2q3) - ay) + (-_8bx*Madg_Fix_q3 + _4bz*Madg_Fix_q1)*(_4bx*(0.5 - q2q2 - q3q3) + _4bz*(q1q3 - q0q2) - mx) + (-_4bx*Madg_Fix_q0 + _4bz*Madg_Fix_q2)*(_4bx*(q1q2 - q0q3) + _4bz*(q0q1 + q2q3) - my) + (_4bx*Madg_Fix_q1)*(_4bx*(q0q2 + q1q3) + _4bz*(0.5 - q1q1 - q2q2) - mz);	recipNorm = invSqrt(s0 * s0 + s1 * s1 + s2 * s2 + s3 * s3); // normalise step magnitude
		s0 *= recipNorm;
		s1 *= recipNorm;
		s2 *= recipNorm;
		s3 *= recipNorm;
